...
EXCEPTION
    WHEN duplicate_object THEN
        RAISE NOTICE 'Tables already added to real-time publication';
    WHEN OTHERS THEN
        RAISE NOTICE 'Could not enable real-time subscriptions: %', SQLERRM;
END $$;
...
BEGIN
    ...
    RAISE NOTICE '• SELECT * FROM public.get_index_recommendations();';
    RAISE NOTICE '';
